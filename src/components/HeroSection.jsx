...
const HeroSection = () => {
  ...
  // ✅ Preload background image before showing
  useEffect(() => {
    const img = new Image();
    img.src = heroImg;
  ...
  return (
    <>
      {/* Hero Section */}
      <section
        className={`relative h-[85vh] flex items-center justify-center text-center text-white transition-opacity duration-700 ${
        ...
        style={{
          ...
          backgroundAttachment: "scroll", // fixed slow karta hai mobile pe
        }}
      >
        {/* Black overlay */}
        ...
        <div className="relative z-10 max-w-2xl px-6">
          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            Transform Your{" "}
            <span className="text-[#F05A28]">Future Today</span>
          </h1>
